...
from user_profile.views import UserProfileView,LevelCreateView,LevelListView,LevelUpdateView,XpHistoryView,ChangePasswordView,GiftStatusView,ClaimXpView,ProfileDetailsView
