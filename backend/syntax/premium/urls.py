...
from premium.views import PremiumPlanCreateView,PremiumPlanListVIew,PremiumPlanOrderView,VerifyPaymentView,CheckSubscriptionView,MembershipHistoryView,CancelSubscriptionView,PremiumPlanUpdateView,PremiumPlanBlockView
...
urlpatterns = [
   ...
   path('<int:id>/block/',PremiumPlanBlockView.as_view(),name='block-plan'),
